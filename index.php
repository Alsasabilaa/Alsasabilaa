  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html " target="_blank">
        <img src="buku.jpg" class="navbar-brand-img h-100" alt="" />
        <span class="ms-1 font-weight-bold">BUKU TAMU</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="?dashboard=rekap">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 43 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>credit-card</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    ...
    <div class="sidenav-footer mx-3">
      <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
        <div class="full-background" style="
              background-image: url('assetss/img/curved-images/white-curved.jpg');
            "></div>
      ...
      <div class="container-fluid py-1 px-3">
            ...
            <form action="" method="get">
              <div class="row">
                <div class="col">
                  ...
                  <input type="hidden" class="form-control" placeholder="Type here..." name="dashboard" value="tamu" />
                </div>
                <div class="col">
        ...
        <ul class="navbar-nav justify-content-end">
          ...
          <li class="nav-item d-flex align-items-center">
            <a href="logout.php" onclick="return confirm(' Anda yakin ingin keluar?')" class="nav-link text-body font-weight-bold px-0">
