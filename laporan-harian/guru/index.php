  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <?php
          if (isset($_GET['guru']) && $_GET['guru'] == 'guru') {
        ...
        <li class="nav-item">
          <?php
          if (isset($_GET['guru']) && $_GET['guru'] == 'siswa') {
            echo '<a class="nav-link active" href="index.html?guru=siswa">';
          } else {
            echo '<a class="nav-link" href="index.html?guru=siswa">';
          }
          ?>
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <?php
          if (isset($_GET['guru']) && $_GET['guru'] == 'kelompok') {
            echo '<a class="nav-link active" href="index.html?guru=kelompok">';
          } else {
            echo '<a class="nav-link" href="index.html?guru=kelompok">';
          }
          ?>
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
